(() => {
    ...
    const exactTranslations = new Map([
        ...
        /* Verified/current EN-facing bonus copy. */
        ["500% на депозит + 250 FS", "Up to 500% welcome bonus"],
        ["125% на депозит + 350 FS", "125% welcome bonus + 350 FS"],
        ["225% на депозит + до 1000 FS", "Up to 200% + 250 FS"],
        ["225% на депозит + 900 FS", "Up to 225% + 900 FS"],
        ["555% на депозит + 555 FS", "Up to 555% + 555 FS"],
        ["400% на депозит + 550 FS", "Up to 400% + 550 FS"],
        ["+ 850 FS", "Up to 850 FS"],
        ["150% на депозит + 350 FS", "Up to 150% + 350 FS"],
        ["425% на депозит + 230 FS", "Up to 425% + 230 FS"]
    ]);
    ...
    const originalProjectTerms = typeof projectsData !== "undefined" && Array.isArray(projectsData)
        ? new Map(projectsData.map((project) => [project.id, project.terms.map((term) => ({ ...term }))]))
        : new Map();
